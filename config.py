...
BOT_TOKEN = environ.get("BOT_TOKEN", "7880140653:AAFwU7Zvs5g5QoneNfLWfs5kuuA61Lf20k0")

PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e48c35aa1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6670233911').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "KaneSuperBot") # without @
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002489615288"))
...
WEBSITE_URL = environ.get("WEBSITE_URL", "Https://hethongtop.com") # Subscribe Telegram Channel For - @Hethongkiemlaiatk
...
# Subscribe Telegram Channel For - @Hethongkiemlaiatk
# My Telegram - @Kane_Ai
